...
public class CreateProductFunctionalTest {
    ...
    void createProductPostIsCorrect(ChromeDriver driver) throws Exception {
        ...
        String productName = driver.findElement(By.cssSelector("tbody tr:first-child td:nth-child(1)")).getText();
        String productQuantity = driver.findElement(By.cssSelector("tbody tr:first-child td:nth-child(2)")).getText();
