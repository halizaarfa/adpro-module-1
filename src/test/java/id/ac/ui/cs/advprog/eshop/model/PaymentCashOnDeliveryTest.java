...
class PaymentCashOnDeliveryTest {
    ...
    void testSetPaymentData() {
        this.paymentData.put("address", "Kukusan Depok");
        this.paymentData.put("deliveryFee", "Rp50.000");
        PaymentCashOnDelivery payment = new PaymentCashOnDelivery("13652556-012a-4c07-b546-54eb1396d79b", PaymentMethod.COD.getValue(), this.paymentData);
